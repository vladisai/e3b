...
class RLLibNLEEnv(gym.Env):
    def __init__(self, env_config: dict) -> None:
        ...
        self._observation_keys = sorted(env_config.get("observation_keys", ("blstats", "glyphs")))
    ...
    def step(self, action: Union[int, np.int64]) -> Tuple[dict, Union[np.number, int], Union[np.bool_, bool], dict]:
