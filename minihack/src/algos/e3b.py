...
def train(flags):
    ...
    elliptical_encoder_optimizer = torch.optim.Adam(
        elliptical_learner_encoder.parameters(), lr=flags.predictor_learning_rate
    )

    inverse_dynamics_optimizer = torch.optim.Adam(inverse_dynamics_model.parameters(), lr=flags.predictor_learning_rate)
