...
parser.add_argument(
    ...
    default=1,
    type=int,
    help="Clip rewards to [-1, 1]. Set 1 for true, 0 for false.",
)
parser.add_argument(
    "--reward_norm",
    default="int",
...
parser.add_argument(
    ...
    default=0,
    type=int,
    help="decay learning rate (1 for true, 0 for false)",
)
...
parser.add_argument("--num_actors", default=256, type=int, metavar="N", help="Number of actors.")
parser.add_argument(
    "--total_frames",
    default=5e7,
    type=int,
...
parser.add_argument(
    "--planning_intrinsic_reward_coef",
    default=0.5,
    type=float,
